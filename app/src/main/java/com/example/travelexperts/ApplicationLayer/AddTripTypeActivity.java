...
public class AddTripTypeActivity extends AppCompatActivity {
    ...
    class PostTripType implements Runnable {
        ...
        public void run() {
            ...
            String url = "http://192.168.1.64:8080/JSPDay3RESTExample/rs/tritype/posttriptype/"+oldTripTypeId;
    ...
    class PutTripType implements Runnable {
        ...
        public void run() {
            //send JSON data to REST service
            String url = "http://192.168.1.64:8080/JSPDay3RESTExample/rs/triptype/puttriptype";
            JSONObject obj = new JSONObject();
            try {
                obj.put("TripTypeId", tripType.getTripTypeId() + "");
                obj.put("TTName", tripType.gettTName() + "");
    ...
    class DeleteTripType implements Runnable {
        ...
        public void run() {
            //retrieve JSON data from REST service into StringBuffer
            StringBuffer buffer = new StringBuffer();
            String url = "http://192.168.1.64:8080/JSPDay3RESTExample/rs/triptype/deletetriptype/" + tripTypeId;
